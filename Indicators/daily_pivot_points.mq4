...
//----
   ...
   ObjectCreate(MPrefix + "R0.5_Line", OBJ_HLINE, 0, 0, R05);
   ObjectSet(MPrefix + "R0.5_Line", OBJPROP_COLOR, GreenYellow);
   ObjectSet(MPrefix + "R0.5_Line", OBJPROP_STYLE, STYLE_DOT);
   ObjectSetText(MPrefix + "R0.5_Line","R0.5 "+DoubleToStr(R05,Digits));

   ObjectCreate(MPrefix + "R1.0_Line", OBJ_HLINE, 0, 0, R10);
   ObjectSet(MPrefix + "R1.0_Line", OBJPROP_COLOR, YellowGreen);
   ObjectSet(MPrefix + "R1.0_Line", OBJPROP_STYLE, STYLE_DOT);
   ObjectSetText(MPrefix + "R1.0_Line","R1.0 "+DoubleToStr(R10,Digits));

   ObjectCreate(MPrefix + "R1.5_Line", OBJ_HLINE, 0, 0, R15);
   ObjectSet(MPrefix + "R1.5_Line", OBJPROP_COLOR, GreenYellow);
   ObjectSet(MPrefix + "R1.5_Line", OBJPROP_STYLE, STYLE_DOT);
   ObjectSetText(MPrefix + "R1.5_Line","R1.5 "+DoubleToStr(R15,Digits));
   ...
   ObjectCreate(MPrefix + "S0.5_Line", OBJ_HLINE, 0, 0, S05);
   ObjectSet(MPrefix + "S0.5_Line", OBJPROP_COLOR, Salmon);
   ObjectSet(MPrefix + "S0.5_Line", OBJPROP_STYLE, STYLE_DOT);
   ObjectSetText(MPrefix + "S0.5_Line","S0.5 "+DoubleToStr(S05,Digits));

   ObjectCreate(MPrefix + "S1.0_Line", OBJ_HLINE, 0, 0, S10);
   ObjectSet(MPrefix + "S1.0_Line", OBJPROP_COLOR, Salmon);
   ObjectSet(MPrefix + "S1.0_Line", OBJPROP_STYLE, STYLE_DOT);
   ObjectSetText(MPrefix + "S1.0_Line","S1.0 "+DoubleToStr(S10,Digits));

   ObjectCreate(MPrefix + "S1.5_Line", OBJ_HLINE, 0, 0, S15);
   ObjectSet(MPrefix + "S1.5_Line", OBJPROP_COLOR, Salmon);
   ObjectSet(MPrefix + "S1.5_Line", OBJPROP_STYLE, STYLE_DOT);
   ObjectSetText(MPrefix + "S1.5_Line","S1.5 "+DoubleToStr(S15,Digits));
